                ...
                <div class="col-12 col-sm-6">
                    ...
                    <div class="col-12">
                        @if (isset($data->gallery[0]) && !is_null($data->gallery[0]))
                            <img src="{{ asset('imagens/imoveis/' . $data->gallery[0]->image) }}"
                                class="product-image img-principal" alt="Product Image">
                        @else
                            <img
            ...
            <div class="card">
                ...
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                            @foreach ($data->listaEspera as $espera)
                            <tr>
                                <td> {{ $espera->user->id }}</td>
                                <td> {{ $espera->user->name }}</td>
                                <td> <a href="#">{{ $espera->user->phone }}</a></td>
                                <td> 
                                    <a href="#" class="btn btn-danger"> Excluir</a>
                                    <a href="#" class="btn btn-success"> Avisar</a>
                                </td>

          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown"> 
              ...
              <ul class="b-none dropdown-menu font-14 animated fadeInUp">
                <li><a class="dropdown-item" href="01-Home-Page.html">home </a>
                </li>
               </ul>
            <li class="nav-item"> 
          ...
          <div class="header_r d-flex">
            <div class="loin"> 
              <a class="nav-link" href="#" data-toggle="modal" data-target="#login">
                <i class="fa fa-user m-r-5"></i>Reginstrar/Logar</a>  
              </div>
            <ul class="ml-auto post_ad">
              <li class="nav-item search">
                <a class="nav-link" href="20-Post_Ad-Page.html">Adicionar Casa</a>
              </li>
            </ul>
          </div>
        </div>

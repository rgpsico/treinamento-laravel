                        ...
                        <tbody>
                            @foreach ($model as $value)
                                <tr>
                                    ...
                                    <td><a   title="Enviar mensagem via WhatsApp" href="{{ whatsappUrlFromPhone($value->user->telefone) }}">
                                        {{$value->user->telefone}}</a>
                                    </td>
                                    <td>
    ...
    $("img.card-img").on("error", function(){
        $(this).attr('src', '{{ asset("images/entregadoravatar.png") }}');
          ...
          $(document).on('change', '#status_entregadores', function(e) {
            ...
            var id = $(this).data('id');
            var url = '/api/profissionais/' + id + '/updatestatus';

    ...
    <div class="row">
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="detail_box"> 
          <img class="img-fluid" src="{{ asset('imagens/imoveis/'.$datas->gallery[0]->image) }}" alt="{{$datas->title}}">
          <div class="m-t-20">
            <ul class="owl-carousel list-unstyled m-b-0" id="product_slider">
            
              @foreach ($datas->gallery as $key => $gallery ) 
                    <li> <img class="img-fluid" src="{{ asset('imagens/imoveis/'.$datas->gallery[$key]->image) }}" alt="slide {{$key}}"> </li>
              @endforeach
            </ul>
          </div>
        </div>
        ...
        <div class="detail_box">
              ...
              <li class="d-inline-block p-r-20">
                <a href="#"> 
                  <i class="fa fa-clock-o">
                    </i> <span>{{$datas->data_created}}</span>
                  </a> 
                  </li>
              <li class="d-inline-block p-r-20">
                <a href="#"> 
            ...
            <div class="row">
              <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12 col-12">
                <div class="form-check">
                  ...
                  <img src="{{asset('images/warrenty.png')}}" alt="{{$datas->title}}">
              ...
              <div class="col-lg-12 col-xl-6 col-md-12 col-sm-12 col-12">
                <div class="form-check">
                  <input class="form-check-input" value="" type="checkbox">
                  <label class="form-check-label"> </label>
                  <img src="{{asset('images/insurance.png')}}" alt="{{$datas->title}}">
          ...
          <div class="detail_prize p-t-10">
            <ul class="list-unstyled">
              ...
              <li class="d-inline-block Price_m"> {{$datas->price}}</li>
            </ul>
          </div>
          
          <div class="detail_btn d-flex m-t-20">
            <button class="btn_chat w-100 text-white mr-3 py-2 border-0" type="submit" value="button">
              <a href="https://api.whatsapp.com/send?phone={{$datas->user->phone}}" target="_blank" style="color:#fff; text-decoration: none;">
